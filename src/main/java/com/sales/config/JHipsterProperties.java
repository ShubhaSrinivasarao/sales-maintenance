...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "salesMaintenance@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "salesMaintenance API";

        private String description = "salesMaintenance API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "salesMaintenance";
